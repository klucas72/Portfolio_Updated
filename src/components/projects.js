            ...
            <div className="row">
                ...
                <div id="work_example" class="col-md-10 col-sm-12">
                    <div className="card text-white bg-secondary mb-3" style={linkStyle}>
                        <img src="/../public/day planner.png" class="card-img-top" alt="electronic day event calendar"></img>
                    ...
                    <div className="card text-white bg-secondary mb-3" style={linkStyle}>
                        <img src="../../public/weather app.png" class="card-img-top" alt="5 day weather forecast application"></img>
                        <div className="card-body">
                    ...
                    <div className="card text-white bg-secondary mb-3" style={linkStyle}>
                        <img src="../../public/recipe finder.png" class="card-img-top"
                    ...
                    <div className="row">
                        ...
                        <div id="work_example2" class="col-md-10 col-sm-12">
                            <div className="card text-white bg-secondary mb-3" style={linkStyle}>
                                <img src="../../public/Tech Blog.png" class="card-img-top"
                                    alt="web application to find recipes based on cuisine"></img>
                                <div className="card-body">
                                ...
                                <div className="card text-white bg-secondary mb-3" style={linkStyle}>
                                    <img src="../../public/Note Taker App.png" class="card-img-top"
                                        alt="web application to find recipes based on cuisine"></img>
                                    <div className="card-body">
                                    ...
                                    <div className="card text-white bg-secondary mb-3" style={linkStyle}>
                                        <img src="../../public/cohoots dashboard.png" class="card-img-top"
                                            alt="web application to find recipes based on cuisine"></img>
                                        <div className="card-body">
